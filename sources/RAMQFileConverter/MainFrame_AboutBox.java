...
class MainFrame_AboutBox extends JDialog implements ActionListener {
    ...
    String product = "RAMQFileConverter";
    String version = "1.1";
    String copyright = "Copyright (c) 2007";
    String comments = "Application to convert RAMQ reclamation files to XML";
    ...
    private void jbInit() throws Exception {
        image1 = new ImageIcon(ramqfileconverter.MainFrame.class.getResource(
                "about.png"));
